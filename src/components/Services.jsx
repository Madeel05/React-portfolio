    ...
    <>
      ...
      <section id="services" className="services">
        <div className="container" data-aos="fade-up">
          ...
          With a strong focus on user experience and cutting-edge technologies, I deliver stunning websites that leave a lasting impression. From e-commerce platforms to sleek portfolios, our team of experienced developers will bring your vision to life.
          </Title>
          <div className="row">
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div className="icon-box iconbox-blue">
                ...
                <h4>Front-end development using HTML, CSS, and JavaScript</h4>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
              <div className="icon-box iconbox-orange ">
                ...
                <h4>Back-end development with frameworks such as Node.js, Codeigniter, or Express</h4>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
              <div className="icon-box iconbox-pink">
                ...
                <h4>Website optimization for speed, performance, and search engine optimization (SEO)</h4>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
              <div className="icon-box iconbox-yellow">
                ...
                <h4>Responsive design for mobile and tablet devices</h4>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
              <div className="icon-box iconbox-red">
                ...
                <h4>Content management system (CMS) integration</h4>
            ...
            <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
              <div className="icon-box iconbox-teal">
                ...
                <h4>Website maintenance and support to ensure your clients' websites are up-to-date</h4>
